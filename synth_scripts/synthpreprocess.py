...
def main():
    base_path = "C:/Users/sebam/Desktop/NLP/progettoMereuNLP/" \
                ...
                "pan-clef-2024-oppositional-main/synth_dataset/"

    # Paths for training and test datasets
    train_file = os.path.join(base_path, "mixed_dataset_2.json")
    train_output = os.path.join(base_path, "mixed_dataset_processed_2.json")
