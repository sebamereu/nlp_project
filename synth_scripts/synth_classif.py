...
# Paths to JSON files
TRAIN_JSON_PATH = r"C:\Users\sebam\Desktop\NLP\progettoMereuNLP\pan-clef-2024-oppositional-main\pan-clef-2024-oppositional-main\synth_dataset\mixed_dataset_processed_2.json"
...
PLOT_DIR = r"C:\Users\sebam\Desktop\NLP\progettoMereuNLP\pan-clef-2024-oppositional-main\pan-clef-2024-oppositional-main\results\synth_plot"
...
def plot_comparison(results, metric='F1-macro'):
    ...
    plt.savefig(os.path.join(PLOT_DIR, f'{metric.lower().replace("-", "_")}_comparison_2.png'))
    plt.close()
...
def plot_confusion_matrix(cm, classnames, model_name, vectorizer_name):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOT_DIR, f'{model_name.lower().replace(" ", "_")}_{vectorizer_name.lower()}_confusion_matrix_2.png'))
    plt.close()
...
with open(os.path.join(PLOT_DIR, "vectorization_comparison_results_2.json"), "w") as f:
    json.dump(results, f, indent=4)

print(f"\nComprehensive results saved to {os.path.join(PLOT_DIR, 'vectorization_comparison_results_2.json')}")
