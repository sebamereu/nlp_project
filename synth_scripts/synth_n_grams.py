...
def main():
    # Paths
    base_path = "C:/Users/sebam/Desktop/NLP/progettoMereuNLP/pan-clef-2024-oppositional-main/pan-clef-2024-oppositional-main/synth_dataset"
    train_file = os.path.join(base_path, "mixed_dataset_processed_2.json")
    output_dir = os.path.join(base_path, "results/synth_ngrams_analysis_2")
    ...
    analyze_ngrams(train_df, 'synth_train', output_dir)
